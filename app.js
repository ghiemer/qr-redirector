...
async function startServer() {
  try {
    ...
    app.post('/admin/routes/delete/:id', ensureAuth, withDb(handleDeleteRoute));
        ...
        // Settings-Routen
    app.get('/admin/settings', ensureAuth, withDb(settingsController.showSettings));
    app.post('/admin/settings', ensureAuth, withDb(settingsController.updateSettings));
    app.post('/admin/settings/otp', ensureAuth, withDb(settingsController.requestSettingsOtp));
    app.post('/admin/settings/reset-counters', ensureAuth, withDb(settingsController.resetCounters));
    app.post('/admin/settings/cleanup-logs', ensureAuth, withDb(settingsController.cleanupLogsAction));
